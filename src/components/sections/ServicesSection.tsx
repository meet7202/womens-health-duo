...
import { HomeServiceTopicLanes } from "@/components/sections/HomeServiceTopicLanes";
...
export const ServicesSection = () => {
  ...
  return (
    <section id="services" className="overflow-hidden" ref={ref}>
      <HomeServiceTopicLanes />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              type="button"
              onClick={() => {
                window.open(bookWhatsAppHref, "_blank", "noopener,noreferrer");
              }}
              className="inline-flex items-center gap-2 text-primary font-medium hover:underline"
            >
              <MessageCircle className="h-4 w-4 shrink-0" aria-hidden />
              Book on WhatsApp to discuss your needs
